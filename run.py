...
def run_kline_analysis():
    ...
    # natr = calculate_volatility_indicators(high_a_hist, low_a_hist, close_a_hist)
    # weighted_close_price = calculate_price(open_a_hist, high_a_hist, low_a_hist, close_a_hist)
